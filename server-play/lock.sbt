...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.typesafe.akka" % "akka-slf4j_2.12" % "2.5.2",
  "com.typesafe.akka" % "akka-stream_2.12" % "2.5.2",
  "com.typesafe.play" % "build-link" % "2.6.0-RC2",
  "com.typesafe.play" % "play-exceptions" % "2.6.0-RC2",
  "com.typesafe.play" % "play-functional_2.12" % "2.6.0-RC2",
  "com.typesafe.play" % "play-json_2.12" % "2.6.0-RC2",
  "com.typesafe.play" % "play-netty-utils" % "2.6.0-RC2",
  "com.typesafe.play" % "play-streams_2.12" % "2.6.0-RC2",
  "com.typesafe.play" % "play_2.12" % "2.6.0-RC2",
  "com.typesafe.play" % "twirl-api_2.12" % "1.3.0",
...
// LIBRARY_DEPENDENCIES_HASH 13abfd72e9e277549890c5edca6f4c537d6532b7
